...
export tauri_deps=(curl wget openssl-devel webkit2gtk-devel appmenu-gtk-module librsvg librsvg-devel libvips gdk-pixbuf-devel cairo-devel pango-devel libsoup-devel libgtkdgl-devel webkit2gtk-devel)
